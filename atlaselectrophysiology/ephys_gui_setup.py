...
class Setup():
    ...
    def init_menubar(self):
        ...
        toggle5_option = QtGui.QAction('Toggle Previous Image Plots', self)
        toggle5_option.setShortcut('Alt+Shift+1')
        toggle5_option.triggered.connect(lambda: self.toggle_plots(self.img_options_group, reverse=True))
        toggle6_option = QtGui.QAction('Toggle Previous Line Plots', self)
        toggle6_option.setShortcut('Alt+Shift+2')
        toggle6_option.triggered.connect(lambda: self.toggle_plots(self.line_options_group, reverse=True))
        toggle7_option = QtGui.QAction('Toggle Previous Probe Plots', self)
        toggle7_option.setShortcut('Alt+Shift+3')
        toggle7_option.triggered.connect(lambda: self.toggle_plots(self.probe_options_group, reverse=True))
        toggle8_option = QtGui.QAction('Toggle Previous Slice Plots', self)
        toggle8_option.setShortcut('Alt+Shift+4')
