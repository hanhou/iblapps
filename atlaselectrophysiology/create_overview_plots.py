...
def make_overview_plot(folder, sess_info, save_folder=None, shank_info=''):
    insertion_name = [name for i,name in enumerate(folder.parts[:-1]) if folder.parts[i+1] == 'alf'][0] + shank_info
    image_folder = folder
